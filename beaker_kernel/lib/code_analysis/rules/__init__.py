...
class TrustRule(ABC):
    ...
    @classmethod
    @abstractmethod
    async def check(cls, data: T, rules: "list[TrustRule]", analyzer: "CodeAnalyzer"):
...
class ASTRule(TrustRule):
    ...
    @classmethod
    async def check(cls, data: Tree, rules: "list[ASTRule]", analyzer: "CodeAnalyzer"):
        for rule in rules:
...
"""
    ...
    @classmethod
    async def check(cls, data: str, rules: "list[LLMRule]", analyzer: "CodeAnalyzer"):
