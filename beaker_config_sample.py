...
#  See also: ServerApp.allow_credentials
...
#  See also: ServerApp.allow_external_kernels
...
#  See also: ServerApp.browser
# c.BaseBeakerApp.browser = ''

## The full path to an SSL/TLS certificate file.
#  See also: ServerApp.certfile
# c.BaseBeakerApp.certfile = ''

## The full path to a certificate authority certificate for SSL/TLS client
#  authentication.
#  See also: ServerApp.client_ca
...
#  See also: ServerApp.config_manager_class
...
#  See also: ServerApp.cookie_options
# c.BaseBeakerApp.cookie_options = {}

## The random bytes used to secure cookies.
#  See also: ServerApp.cookie_secret
# c.BaseBeakerApp.cookie_secret = b''

## The file where the cookie secret is stored.
#  See also: ServerApp.cookie_secret_file
# c.BaseBeakerApp.cookie_secret_file = ''

## Override URL shown to users.
#  See also: ServerApp.custom_display_url
# c.BaseBeakerApp.custom_display_url = ''

## The default URL to redirect to from `/`
#  See also: ServerApp.default_url
...
#  See also: ServerApp.get_secure_cookie_kwargs
# c.BaseBeakerApp.get_secure_cookie_kwargs = {}

## The identity provider class to use.
#  See also: ServerApp.identity_provider_class
...
#  See also: ServerApp.iopub_data_rate_limit
# c.BaseBeakerApp.iopub_data_rate_limit = 0.0

## DEPRECATED. Use ZMQChannelsWebsocketConnection.iopub_msg_rate_limit
#  See also: ServerApp.iopub_msg_rate_limit
# c.BaseBeakerApp.iopub_msg_rate_limit = 0.0

## The IP address the Jupyter server will listen on.
#  See also: ServerApp.ip
# c.BaseBeakerApp.ip = 'localhost'

## Supply extra arguments that will be passed to Jinja environment.
#  See also: ServerApp.jinja_environment_options
# c.BaseBeakerApp.jinja_environment_options = {}

## Extra variables to supply to jinja templates when rendering.
#  See also: ServerApp.jinja_template_vars
...
#  See also: ServerApp.jpserver_extensions
...
#  See also: ServerApp.kernel_websocket_connection_class
...
#  See also: ServerApp.kernel_ws_protocol
# c.BaseBeakerApp.kernel_ws_protocol = ''

## The full path to a private key file for usage with SSL/TLS.
#  See also: ServerApp.keyfile
# c.BaseBeakerApp.keyfile = ''

## DEPRECATED. Use ZMQChannelsWebsocketConnection.limit_rate
#  See also: ServerApp.limit_rate
# c.BaseBeakerApp.limit_rate = False

## Hostnames to allow as local when allow_remote_access is False.
#  See also: ServerApp.local_hostnames
...
#  See also: ServerApp.notebook_dir
# c.BaseBeakerApp.notebook_dir = ''

#  Default: False
# c.BaseBeakerApp.open_browser = False

## DEPRECATED in 2.0. Use PasswordIdentityProvider.hashed_password
#  See also: ServerApp.password
# c.BaseBeakerApp.password = ''

## DEPRECATED in 2.0. Use PasswordIdentityProvider.password_required
#  See also: ServerApp.password_required
# c.BaseBeakerApp.password_required = False

## The port the server will listen on (env: JUPYTER_PORT).
#  See also: ServerApp.port
# c.BaseBeakerApp.port = 0

## The number of additional ports to try if the specified port is not available
#  (env: JUPYTER_PORT_RETRIES).
#  See also: ServerApp.port_retries
...
#  See also: ServerApp.preferred_dir
# c.BaseBeakerApp.preferred_dir = ''

## 
#  See also: ServerApp.pylab
# c.BaseBeakerApp.pylab = 'disabled'

## If True, display controls to shut down the Jupyter server, such as menu items
#  or buttons.
#  See also: ServerApp.quit_button
# c.BaseBeakerApp.quit_button = True

## DEPRECATED. Use ZMQChannelsWebsocketConnection.rate_limit_window
#  See also: ServerApp.rate_limit_window
# c.BaseBeakerApp.rate_limit_window = 0.0

## The directory to use for notebooks and kernels.
#  See also: ServerApp.root_dir
...
#  See also: ServerApp.terminado_settings
# c.BaseBeakerApp.terminado_settings = {}

## Set to False to disable terminals.
#  See also: ServerApp.terminals_enabled
# c.BaseBeakerApp.terminals_enabled = False

## DEPRECATED. Use IdentityProvider.token
#  See also: ServerApp.token
# c.BaseBeakerApp.token = '<DEPRECATED>'

## Supply overrides for the tornado.web.Application that the Jupyter server uses.
#  See also: ServerApp.tornado_settings
# c.BaseBeakerApp.tornado_settings = {}

## Whether to trust or not X-Scheme/X-Forwarded-Proto and X-Real-Ip/X-Forwarded-
#  For headerssent by the upstream reverse proxy. Necessary if the proxy handles
#  SSL
#  See also: ServerApp.trust_xheaders
...
#  See also: IdentityProvider.token
# c.BeakerIdentityProvider.token = '<generated>'

#------------------------------------------------------------------------------
# NotebookIdentityProvider(BeakerIdentityProvider, IdentityProvider) configuration
#------------------------------------------------------------------------------
## Header name for Beaker kernel authentication
#  See also: BeakerIdentityProvider.beaker_kernel_header
# c.NotebookIdentityProvider.beaker_kernel_header = 'X-AUTH-BEAKER'

## Name of the cookie to set for persisting login. Default: username-${Host}.
#  See also: IdentityProvider.cookie_name
# c.NotebookIdentityProvider.cookie_name = ''

## Extra keyword arguments to pass to `set_secure_cookie`. See tornado's
#  set_secure_cookie docs for details.
#  See also: IdentityProvider.cookie_options
# c.NotebookIdentityProvider.cookie_options = {}

## Extra keyword arguments to pass to `get_secure_cookie`. See tornado's
#  get_secure_cookie docs for details.
#  See also: IdentityProvider.get_secure_cookie_kwargs
# c.NotebookIdentityProvider.get_secure_cookie_kwargs = {}

## The login handler class to use, if any.
#  See also: IdentityProvider.login_handler_class
# c.NotebookIdentityProvider.login_handler_class = 'jupyter_server.auth.login.LoginFormHandler'

## The logout handler class to use.
#  See also: IdentityProvider.logout_handler_class
# c.NotebookIdentityProvider.logout_handler_class = 'jupyter_server.auth.logout.LogoutHandler'

## Specify whether login cookie should have the `secure` property (HTTPS-
#  only).Only needed when protocol-detection gives the wrong answer due to
#  proxies.
#  See also: IdentityProvider.secure_cookie
# c.NotebookIdentityProvider.secure_cookie = None

## Token used for authenticating first-time connections to the server.
#  See also: IdentityProvider.token
# c.NotebookIdentityProvider.token = '<generated>'
...
# c.BeakerKernelSpecManager.whitelist = set()
...
#------------------------------------------------------------------------------
# IdentityProvider(LoggingConfigurable) configuration
#------------------------------------------------------------------------------
...
## Name of the cookie to set for persisting login. Default: username-${Host}.
#  Default: ''
# c.IdentityProvider.cookie_name = ''
...
#  get_secure_cookie docs for details.
#  Default: {}
# c.IdentityProvider.get_secure_cookie_kwargs = {}

## The login handler class to use, if any.
#  Default: 'jupyter_server.auth.login.LoginFormHandler'
# c.IdentityProvider.login_handler_class = 'jupyter_server.auth.login.LoginFormHandler'

## The logout handler class to use.
#  Default: 'jupyter_server.auth.logout.LogoutHandler'
# c.IdentityProvider.logout_handler_class = 'jupyter_server.auth.logout.LogoutHandler'

## Specify whether login cookie should have the `secure` property (HTTPS-
#  only).Only needed when protocol-detection gives the wrong answer due to
#  proxies.
#  Default: None
# c.IdentityProvider.secure_cookie = None
...
#  Default: '<generated>'
# c.IdentityProvider.token = '<generated>'
...
## Hash algorithm to use for file content, support by hashlib
#  Choices: any of ['sm3', 'sha256', 'shake_128', 'blake2b', 'sha512', 'shake_256', 'sha3_512', 'md5-sha1', 'sha384', 'sha224', 'sha512_224', 'sha3_384', 'md5', 'sha1', 'blake2s', 'sha3_256', 'ripemd160', 'sha512_256', 'sha3_224']
#  Default: 'sha256'
...
#------------------------------------------------------------------------------
# AsyncLargeFileManager(AsyncFileContentsManager) configuration
#------------------------------------------------------------------------------
## Handle large file upload asynchronously

## Allow access to hidden files
#  See also: ContentsManager.allow_hidden
# c.AsyncLargeFileManager.allow_hidden = False

## If True, deleting a non-empty directory will always be allowed.
#  See also: FileContentsManager.always_delete_dir
# c.AsyncLargeFileManager.always_delete_dir = False

#  See also: AsyncContentsManager.checkpoints
# c.AsyncLargeFileManager.checkpoints = None

#  See also: AsyncContentsManager.checkpoints_class
# c.AsyncLargeFileManager.checkpoints_class = 'jupyter_server.services.contents.checkpoints.AsyncCheckpoints'

#  See also: AsyncContentsManager.checkpoints_kwargs
# c.AsyncLargeFileManager.checkpoints_kwargs = {}
...
#  See also: ContentsManager.event_logger
# c.AsyncLargeFileManager.event_logger = None

## handler class to use when serving raw file requests.
#  See also: ContentsManager.files_handler_class
# c.AsyncLargeFileManager.files_handler_class = 'jupyter_server.files.handlers.FilesHandler'

## Extra parameters to pass to files_handler_class.
#  See also: ContentsManager.files_handler_params
# c.AsyncLargeFileManager.files_handler_params = {}

## Hash algorithm to use for file content, support by hashlib
#  See also: FileManagerMixin.hash_algorithm
# c.AsyncLargeFileManager.hash_algorithm = 'sha256'

## 
#  See also: ContentsManager.hide_globs
# c.AsyncLargeFileManager.hide_globs = ['__pycache__', '*.pyc', '*.pyo', '.DS_Store', '*~']

## The max folder size that can be copied
#  See also: FileContentsManager.max_copy_folder_size_mb
# c.AsyncLargeFileManager.max_copy_folder_size_mb = 500

## Python callable or importstring thereof
#  See also: ContentsManager.post_save_hook
# c.AsyncLargeFileManager.post_save_hook = None

## Python callable or importstring thereof
#  See also: ContentsManager.pre_save_hook
# c.AsyncLargeFileManager.pre_save_hook = None

## Preferred starting directory to use for notebooks. This is an API path (`/`
#  separated, relative to root dir)
#  See also: ContentsManager.preferred_dir
# c.AsyncLargeFileManager.preferred_dir = ''

#  See also: FileContentsManager.root_dir
# c.AsyncLargeFileManager.root_dir = ''

## The base name used when creating untitled directories.
#  See also: ContentsManager.untitled_directory
# c.AsyncLargeFileManager.untitled_directory = 'Untitled Folder'

## The base name used when creating untitled files.
#  See also: ContentsManager.untitled_file
# c.AsyncLargeFileManager.untitled_file = 'untitled'

## The base name used when creating untitled notebooks.
#  See also: ContentsManager.untitled_notebook
# c.AsyncLargeFileManager.untitled_notebook = 'Untitled'

## By default notebooks are saved on disk on a temporary file and then if
#  successfully written, it replaces the old ones.
#  See also: FileManagerMixin.use_atomic_writing
# c.AsyncLargeFileManager.use_atomic_writing = True
...
#  Choices: any of ['sha3_512', 'sha1', 'blake2b', 'sha256', 'sha3_384', 'sha512', 'blake2s', 'sha3_256', 'md5', 'sha3_224', 'sha384', 'sha224']
#  Default: 'sha256'
